About py-pandoc-crossref-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-pandoc-crossref-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6173&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-pandoc-crossref-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-pandoc-crossref` can be installed with `conda`:
...
```
mamba install py-pandoc-crossref
```

It is possible to list all of the versions of `py-pandoc-crossref` available on your platform with `conda`:
...
```
mamba search py-pandoc-crossref --channel conda-forge
```
...
mamba repoquery search py-pandoc-crossref --channel conda-forge

# List packages depending on `py-pandoc-crossref`:
mamba repoquery whoneeds py-pandoc-crossref --channel conda-forge

# List dependencies of `py-pandoc-crossref`:
mamba repoquery depends py-pandoc-crossref --channel conda-forge
```
